...
train_dataset = yoloDataset(root=file_root,list_file=['/mnt/workspace/pytorch-YOLO-v1/voc2012.txt','/mnt/workspace/pytorch-YOLO-v1/voc2007.txt'],train=True,transform = [transforms.ToTensor()] )
...
test_dataset = yoloDataset(root=file_root,list_file='/mnt/workspace/pytorch-YOLO-v1/voc2007test.txt',train=False,transform = [transforms.ToTensor()] )
