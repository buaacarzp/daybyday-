...
class yoloDataset(data.Dataset):
    ...
    def __init__(self,root,list_file,train,transform):
        '''
        root = '/home/xzh/data/VOCdevkit/VOC2012/allimgs/'
        list_file=['/mnt/workspace/pytorch-YOLO-v1/voc2012.txt','/mnt/workspace/pytorch-YOLO-v1/voc2007.txt']
        '''
        print('data init')
        self.root=root
        self.train = train
        ...
        if isinstance(list_file, list):
            ...
            tmp_file = '/mnt/VOC0712/listfile.txt'
            os.system('cat %s > %s' % (' '.join(list_file), tmp_file)) #仅仅是利用linux命令将两个文件合并成一个文件
            list_file = tmp_file
