...
class LogicProtocol:
    ...
    async def AnalysisProtocol(self,recvMsg):
        ...
        if _ID == 1001:
            ...
            algoresults = self.Face_algorithm.Face_detect_start1002(_DICT_Str)
            sendId = 1002
            _PACK_DATA = Utils.pack(sendId,algoresults)
            return _PACK_DATA
        elif _ID ==1003:
            algoresults = self.Face_algorithm.Face_detect_stop1003(_DICT_Str)
            sendId = 1003
            _PACK_DATA = Utils.pack(sendId,algoresults)
            return _PACK_DATA
        elif _ID ==1004:
        ...
        #人体姿态信令解析
            ...
            algoresults = self.Pose_algorithm.Pose_Assessment_prepare2001(_DICT_Str)
            sendId = 2001
            _PACK_DATA = Utils.pack(sendId,algoresults)
            return _PACK_DATA
        elif _ID ==2002:
